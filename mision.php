...
<div class="container custom-bg my-4">
        <div class="row">
            <div class="col-12">
                <p>En RUIZINI, nos dedicamos a proporcionar soluciones informáticas innovadoras y confiables que potencien el éxito de nuestros clientes. Nos comprometemos a ofrecer servicios de la más alta calidad, abrazando la innovación tecnológica y contribuyendo al progreso social.</p>
            </div>
        </div>
    </div>
